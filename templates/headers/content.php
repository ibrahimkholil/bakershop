...
<article <?php post_class( $post_class ) ?> >
		...
		<div class="entry-content <?php echo !$show_blog_thumbnail?'no-featured-image':'' ?>">
			...
			<div class="entry-summary">
				<div class="short-content">
					...
					if( $max_words != '-1' ){
						mydecor_the_excerpt_max_words($max_words, $post, $strip_tags, '', true);
					}
			...
			<?php if( $theme_options['ts_blog_date'] || $theme_options['ts_blog_author'] || $theme_options['ts_blog_comment'] ): ?>
					...
					<div class="entry-meta-top">
						...
						<span class="comment-count">
							<?php
							echo mydecor_get_post_comment_count();
							?>
						</span>
						<?php endif; ?>
			...
			<div class="entry-meta-bottom">
				<a class="button-readmore button button-primary" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read more...', 'mydecor'); ?></a>
			</div>
			<?php endif; ?>
	...
	<?php else: ?>
		<blockquote>
			...
			<!-- Blog Date Time -->
			<?php if( $theme_options['ts_blog_author'] || $theme_options['ts_blog_date'] || $theme_options['ts_blog_categories'] ) : ?>
